...
extern float naivepairscorefast( char *seq1, char *seq2, int *skip1, int *skip2, int penal );
...
extern void fixed_musclesupg_float_realloc_nobk_halfmtx( int nseq, float **eff, int ***topol, float **len, Treedep *, int progressout, int efffree );
extern void loadtop( int nseq, float **mtx, int ***topol, float **len, char **name, int *nlen, Treedep * );
...
extern void fixed_musclesupg_float_realloc_nobk_halfmtx_treeout( int nseq, float **eff, int ***topol, float **len, char **name, int *nlen, Treedep *, int efffree );
extern void fixed_supg_float_realloc_nobk_halfmtx_treeout_constrained( int nseq, float **eff, int ***topol, float **len, char **name, int *nlen, Treedep *, int ncons, int **constraints, int efffree );
